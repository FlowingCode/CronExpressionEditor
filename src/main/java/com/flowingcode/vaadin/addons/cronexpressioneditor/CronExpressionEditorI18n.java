...
public class CronExpressionEditorI18n implements Serializable {
  ...
  private CronExpressionEditorI18n() {
    ...
    this.units = new ArrayList<>(List.of("Seconds", "Minutes", "Hours"));
   ...
   */
  public void setLayoutOptions(Map<LayoutOptions, String> layoutOptions) {
   ...
   */
  public void setStartsAtLabel(String startsAtLabel) {
   ...
   * @return this instance for method chaining
   */
  public CronExpressionEditorI18n setUnits(List<String> units) {
    this.units = units;
    return this;
  }
